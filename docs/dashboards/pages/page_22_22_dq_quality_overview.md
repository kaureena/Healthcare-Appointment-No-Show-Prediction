# Page 22 — Dq Quality Overview

![Dashboard Page 22](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_22_22_dq_quality_overview.png>)

## Why this page exists
DQ pass/fail summary and top failing rules.

### What you should get from this page
- DQ overview: pass/fail summary per table and top failing checks (raw layer).
- Designed to show realistic data defects and that cleansing resolves them in staged/curated layers.
