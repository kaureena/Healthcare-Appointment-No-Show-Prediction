# Page 24 — Pipeline Health

![Dashboard Page 24](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_24_24_pipeline_health.png>)

## Why this page exists
Pipeline run register and SLA compliance.

### What you should get from this page
- Pipeline health overview with synthetic run/step health summaries and SLA checks.
- Supports end-to-end observability from ingestion to reporting.
