# Page 17 — Monitoring Overview

![Dashboard Page 17](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_17_17_monitoring_overview.png>)

## Why this page exists
Monitoring overview: drift, freshness, latency, alerts.

### What you should get from this page
- High-level monitoring console: drift, freshness, API latency, and error rate.
- First stop for incident triage and trend diagnosis.
