# Page 03 — No Show Drivers

![Dashboard Page 03](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_03_03_no_show_drivers.png>)

## Why this page exists
Feature driver view: lead time, prior history, deprivation, channel.

### What you should get from this page
- Explains primary drivers behind no-shows using segmentation panels (lead time, prior history, deprivation, channel).
- Supports targeted interventions instead of broad blanket policies.
