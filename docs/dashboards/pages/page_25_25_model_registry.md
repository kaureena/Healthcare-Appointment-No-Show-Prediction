# Page 25 — Model Registry

![Dashboard Page 25](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_25_25_model_registry.png>)

## Why this page exists
Registry overview of model runs and metrics.

### What you should get from this page
- Model registry dashboard showing run history and promotion stages (simulated for richness).
- Supports reproducibility, audit, and rollback readiness.
