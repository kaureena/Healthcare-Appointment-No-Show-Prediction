# Page 07 — Clinic Performance Leaderboard

![Dashboard Page 07](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_07_07_clinic_performance_leaderboard.png>)

## Why this page exists
Clinic leaderboard with KPIs and risk mix.

### What you should get from this page
- Leaderboard of clinic performance with a risk mix overlay (volume, no-show rate, high-risk share, SMS coverage).
- Use for operational coaching, targeted outreach, and process standardization.
