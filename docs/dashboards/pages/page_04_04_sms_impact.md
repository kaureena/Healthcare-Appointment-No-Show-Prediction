...
![Dashboard Page 04](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_04_04_sms_impact.png>)

## Why this page exists
Reminder coverage and measured impact on no-show rates.

### What you should get from this page
- Quantifies reminder coverage and impact, comparing no-show rates for SMS vs non-SMS appointments.
- Identifies clinics / channels with low reminder coverage and elevated no-show rates.
