# Page 12 — Age And Equity Slices

![Dashboard Page 12](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_12_12_age_and_equity_slices.png>)

## Why this page exists
Age bands and fairness/equity slices (illustrative).

### What you should get from this page
- Equity slice dashboard: age bands, gender slices, and risk distribution.
- Use for fairness review and to detect disproportionate impact of interventions.
