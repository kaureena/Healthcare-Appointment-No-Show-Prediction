# Page 28 — Cohort Retention

![Dashboard Page 28](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_28_28_cohort_retention.png>)

## Why this page exists
Cohort style follow-up adherence (illustrative).

### What you should get from this page
- Cohort-style retention view derived from repeat visit behavior (synthetic).
- Helps quantify follow-up adherence and identify drop-off points.
