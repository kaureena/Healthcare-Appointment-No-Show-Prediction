# Page 20 — Api Latency And Errors

![Dashboard Page 20](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_20_20_api_latency_and_errors.png>)

## Why this page exists
Latency percentiles and error rates with incident markers.

### What you should get from this page
- Service monitoring dashboard: latency percentiles and error rate time series.
- Use during deployments and high-volume periods to validate inference stability.
