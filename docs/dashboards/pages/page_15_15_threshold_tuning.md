# Page 15 — Threshold Tuning

![Dashboard Page 15](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_15_15_threshold_tuning.png>)

## Why this page exists
Model threshold tuning panel for ops trade-offs.

### What you should get from this page
- Ops-focused threshold tuning: how many patients are flagged vs how many no-shows are prevented.
- Use to align model threshold with outreach capacity (calls/day) and SLA expectations.
