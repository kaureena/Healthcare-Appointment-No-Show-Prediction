# Page 26 — Retrain Playbook

![Dashboard Page 26](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_26_26_retrain_playbook.png>)

## Why this page exists
Retrain triggers and runbook summary.

### What you should get from this page
- Runbook dashboard for retrain triggers, decision gates, and checklist steps.
- Helps align engineering + analytics + ops during retraining events.
