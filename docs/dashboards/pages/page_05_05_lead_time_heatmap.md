# Page 05 — Lead Time Heatmap

![Dashboard Page 05](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_05_05_lead_time_heatmap.png>)

## Why this page exists
Heatmap of no-show rate by lead-time band and DOW.

### What you should get from this page
- Heatmap view of no-show rate across lead-time band and day-of-week combinations.
- Helps tune scheduling policies (e.g., avoid long lead time for high-risk cohorts).
