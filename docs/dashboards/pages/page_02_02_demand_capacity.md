# Page 02 — Demand Capacity

![Dashboard Page 02](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_02_02_demand_capacity.png>)

## Why this page exists
Demand vs capacity by clinic and time-of-day.

### What you should get from this page
- Compares demand vs estimated capacity to identify overbooking risk and staffing mismatches.
- Highlights peak slots (weekday × hour) that correlate with higher no-show risk and capacity strain.
