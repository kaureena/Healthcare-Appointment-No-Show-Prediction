# Page 13 — Prior History Segmentation

![Dashboard Page 13](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_13_13_prior_history_segmentation.png>)

## Why this page exists
Segments by prior no-show count and effect on risk.

### What you should get from this page
- Segments population by prior no-show history and quantifies incremental risk.
- Supports repeat no-show prevention policies (e.g., targeted reminders, assisted scheduling).
