# Page 19 — Freshness Sla

![Dashboard Page 19](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_19_19_freshness_sla.png>)

## Why this page exists
Freshness gauges and pipeline refresh audit.

### What you should get from this page
- Freshness and pipeline SLA panel for data delivery health checks.
- Helps detect broken ingestion, delayed refresh, or upstream system outages.
