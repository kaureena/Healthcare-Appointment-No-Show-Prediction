# Page 11 — Booking Channel Trends

![Dashboard Page 11](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_11_11_booking_channel_trends.png>)

## Why this page exists
Channel share trend and no-show rate trend.

### What you should get from this page
- Tracks booking channel share over time and the associated no-show risk.
- Highlights digital vs walk-in vs call-center differences for policy tuning.
