# Page 08 — Neighbourhood Hotspots

![Dashboard Page 08](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_08_08_neighbourhood_hotspots.png>)

## Why this page exists
Map-like scatter hotspots using lat/lon with risk intensity.

### What you should get from this page
- Map-like hotspot view (lat/lon scatter) with risk intensity.
- Pairs socio-economic deprivation context with predicted risk and actual no-show outcomes.
