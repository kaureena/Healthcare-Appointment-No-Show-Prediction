# Page 27 — What If Simulator

![Dashboard Page 27](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_27_27_what_if_simulator.png>)

## Why this page exists
What-if scenario cards for SMS and lead-time policies.

### What you should get from this page
- What-if scenario view: compare intervention options (SMS, calls, policy) and expected impact (illustrative).
- Designed for stakeholders to understand tradeoffs and capacity constraints.
