# Page 10 — Appointment Type Mix

![Dashboard Page 10](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_10_10_appointment_type_mix.png>)

## Why this page exists
Pie/donut composition by appointment type and channel.

### What you should get from this page
- Breaks down demand by appointment type and overlays no-show risk differences.
- Use to redesign pathways (telehealth, follow-ups, reminders) for the riskiest visit types.
