# Page 21 — Alert Register

![Dashboard Page 21](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_21_21_alert_register.png>)

## Why this page exists
Alert register with severity and status.

### What you should get from this page
- Unified alert register (derived) with severity, status, and type.
- Use as operational source-of-truth for incident response and postmortems.
