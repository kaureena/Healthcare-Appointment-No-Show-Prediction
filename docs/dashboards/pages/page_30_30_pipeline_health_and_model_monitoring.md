# Page 30 — Pipeline Health And Model Monitoring

![Dashboard Page 30](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_30_30_pipeline_health_and_model_monitoring.png>)

## Why this page exists
Combined NOC page: drift + SLA + latency + risk mix.

### What you should get from this page
- Single NOC-style ‘war room’ page combining risk mix + drift + freshness + API health.
- Used as the main monitoring page during releases or incident response.
