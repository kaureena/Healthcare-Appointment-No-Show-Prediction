# Page 06 — Dow Hour Heatmap

![Dashboard Page 06](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_06_06_dow_hour_heatmap.png>)

## Why this page exists
No-show heatmap by weekday x hour.

### What you should get from this page
- Identifies peak risk appointment slots using weekday × hour heatmaps.
- Useful for staffing, reminder timing, and slot reallocation planning.
