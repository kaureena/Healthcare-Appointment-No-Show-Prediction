...
![Dashboard Page 01](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_01_01_executive_overview.png>)

## Why this page exists
Executive overview of demand, no-show rate, risk bands, and SLA status.

### What you should get from this page
- One-screen snapshot for leadership: demand, no-show rate trend, risk mix, and operational SLA signals.
- Use this page for weekly business review and to select the drill-down path (clinic, neighbourhood, channel, or cohort).
