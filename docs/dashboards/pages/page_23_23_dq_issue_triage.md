# Page 23 — Dq Issue Triage

![Dashboard Page 23](<../../../v2_mlops_modernisation/bi_powerbi/exports/page_23_23_dq_issue_triage.png>)

## Why this page exists
Issue register and triage workflow.

### What you should get from this page
- Issue triage workflow: current open issues, severity, status, and remediation owner suggestions.
